        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    {
                        case "overrun": // 100041637: // id_01
                            //m_TextPopup_RectTransform.position = worldPointInRectangle;
                            m_TextPopup_TMPComponent.text = "Excess damage after striking a unit will be dealt to any unit or Tower behind it";
                            break;
                        case "fragile": // 100041638: // id_02
                            //m_TextPopup_RectTransform.position = worldPointInRectangle;
                            m_TextPopup_TMPComponent.text = "This unit disapper after strike or at the end of the turn";
                            break;
                        case "combo":
                            //m_TextPopup_RectTransform.position = worldPointInRectangle;
                            m_TextPopup_TMPComponent.text = "In Combat phase, this unit can strike once again after striking enemy units";
                            break;
                        case "breaker":
                            m_TextPopup_TMPComponent.text = "Deals X extra damage upon attacking a Tower";
                            break;
                        case "cleave":
                            m_TextPopup_TMPComponent.text = "Also deals X damage to the unit next to the struck target in the same lane";
                            break;
                        case "godslayer":
                            m_TextPopup_TMPComponent.text = "When it strikes a God, deal X bonus damage to that God";
                            break;
                        case "pierce":
                            m_TextPopup_TMPComponent.text = "<style=Prepare>COMBAT only:</style>When strike an enemy, the enemy or Tower behind it also takes equal damage";
                            break;
                    }
                }
